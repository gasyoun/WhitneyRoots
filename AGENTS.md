...
[generated-block: repo-context — do not hand-edit; regenerated by Uprava tools/gen_repo_context.py; content-hash: 8f8931b2f3]
...
- Cross-repo data edges (from [Uprava interlinks_edges.tsv](https://github.com/gasyoun/Uprava/blob/main/interlinks_edges.tsv)):
  ...
  - ← from `MWS` (consumes): MW-Whitney-DCS root triangulation join (SHARED_CODE s17) (live)
  - ← from `csl-atlas` (consumes): review reports <-> reviewed files mapping (live)
