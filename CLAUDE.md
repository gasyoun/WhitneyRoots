...
| `Whitney_Transition_Runbook.md` | **Pointer stub** → `docs/BUILD_MANUAL.md` (the operator/build manual is the document this name promised) |
...
- `Whitney_Transition_Runbook.md` — a pointer stub to `docs/BUILD_MANUAL.md`;
  don't put content here, extend the manual instead.
